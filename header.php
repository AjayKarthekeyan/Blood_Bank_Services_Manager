<nav class="navbar navbar-expand-sm navbar-light bg-light sticky-top">
	<div class="container">
		<a class="navbar-brand" href="index.php"><img src="image/logo.png" width="30" height="30" class="rounded-circle">Emergency Bank</a>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link btn btn-light" href="bloodreq.php">Blood Request</a>
            </li>
