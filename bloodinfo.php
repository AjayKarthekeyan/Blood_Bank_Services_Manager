...
<body>
  <?php require 'header.php'; ?>
    ...
    <div class="container cont">
     ...
     <?php if(isset($_SESSION['hid']) || isset($_SESSION['did'])){
        $hid = isset($_SESSION['hid']) ? $_SESSION['hid'] : $_SESSION['did'];
        $idField = isset($_SESSION['hid']) ? 'hid' : 'did';
        $tableName = isset($_SESSION['hid']) ? 'bloodinfo' : 'donor_table';
        $sql = "select * from $tableName where $idField='$hid'";
    ...
    <div class="col-lg-4 col-md-5 col-sm-6 col-xs-7 mb-5">
          <table class="table table-striped table-responsive">
            ...
            <tr>
              ...
              <td><a href="file/delete.php?bid=<?php echo $row['bid'];?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this blood sample?')">Delete</a></td>
            </tr>
            <?php } ?>
          </table>
      </div>
