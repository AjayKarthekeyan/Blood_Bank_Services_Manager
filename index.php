        ...
        <div class="row justify-content-center">
            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-5 col-xs-6 mb-5" style="width: 60%">
                <div class="card">
                    ...
                    <img src="image/back1.jpg" class="card-img-top">
                    <img src="image/back2.jpg" class="card-img-top">
                </div>
            </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12 mb-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <i class="fa fa-envelope"> </i> <a > donatewithcare@emergencybank.com</a><br><br>
                        <i class="fa fa-mobile"> </i> <a > 044 4444 5555</a><br><br>
                    </div>
                </div>
            </div>
            </div>
        ...
        <div class="row mb-5">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="https://www.healthline.com/nutrition/27-health-and-nutrition-tips" target="_blank">Healthy & Happy Living Tips</a>
                </div>
            </div>
            </div>
        </div>
